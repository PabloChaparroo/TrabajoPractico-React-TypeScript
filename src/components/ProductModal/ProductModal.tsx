...
//Dependencia para validad formulario
import * as Yup from "yup";
import {useFormik} from "formik"; 

import ProductService from "../../services/ProductService";

//Notificacion al usaurio
...
const handleDelete = async () => {
    try{
        await ProductService.deleteProduc(prod.id);
        onHide();   
...
function handleSaveUpdate(obj: Product): void | Promise<any> {
